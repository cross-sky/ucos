...
__root  const  APP_INTVECT_ELEM  __vector_table[] @ ".intvec" = {
    ...
    BSP_IntHandlerFMC,                                         /* 64, INTISR[ 48]  FSMC global Int.                      */
    ...
    BSP_IRQHandlerUART7,                                        //   ; UART7
    BSP_IRQHandlerUART8,                                            //    ; UART8
    BSP_IRQHandlerSPI4,                                             //     ; SPI4
    BSP_IRQHandlerSPI5,                                             //     ; SPI5
    BSP_IRQHandlerSPI6,                                             //     ; SPI6
    BSP_IRQHandlerSAI1,                                             //     ; SAI1
    BSP_IRQHandlerLTDC,                                             //     ; LTDC
    BSP_IRQHandlerLTDC_ER,                                          //  ; LTDC error
    BSP_IRQHandlerDMA2D                                             //    ; DMA2D
};
