...
void  BSP_IntHandlerFMC               (void)  { BSP_IntHandler(BSP_INT_ID_FSMC);                }
...
void  BSP_IRQHandlerUART7              (void)  { BSP_IntHandler(BSP_INT_ID_UART7);                }
void  BSP_IRQHandlerUART8              (void)  { BSP_IntHandler(BSP_INT_ID_UART8);                }
void  BSP_IRQHandlerSPI4               (void)  { BSP_IntHandler(BSP_INT_ID_SPI4);                 }
void  BSP_IRQHandlerSPI5               (void)  { BSP_IntHandler(BSP_INT_ID_SPI5);                 }
void  BSP_IRQHandlerSPI6               (void)  { BSP_IntHandler(BSP_INT_ID_SPI6);                 }
void  BSP_IRQHandlerSAI1               (void)  { BSP_IntHandler(BSP_INT_ID_SAI1);                 }
void  BSP_IRQHandlerLTDC               (void)  { BSP_IntHandler(BSP_INT_ID_LTDC);                 }
void  BSP_IRQHandlerLTDC_ER            (void)  { BSP_IntHandler(BSP_INT_ID_LTDC_error);           }
void  BSP_IRQHandlerDMA2D              (void)  { BSP_IntHandler(BSP_INT_ID_FPU);                  }
