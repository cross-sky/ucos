...
#define  BSP_INT_ID_UART7                                 82
#define  BSP_INT_ID_UART8                                 83
#define  BSP_INT_ID_SPI4                                  84
#define  BSP_INT_ID_SPI5                                  85
#define  BSP_INT_ID_SPI6                                  86
#define  BSP_INT_ID_SAI1                                  87
#define  BSP_INT_ID_LTDC                                  88
#define  BSP_INT_ID_LTDC_error                            89
#define  BSP_INT_ID_DMA2D                                 90
...
void         BSP_IRQHandlerUART7              (void);
void         BSP_IRQHandlerUART8              (void);
void         BSP_IRQHandlerSPI4               (void);
void         BSP_IRQHandlerSPI5               (void);
void         BSP_IRQHandlerSPI6               (void);
void         BSP_IRQHandlerSAI1               (void);
void         BSP_IRQHandlerLTDC               (void);
void         BSP_IRQHandlerLTDC_ER            (void);
void         BSP_IRQHandlerDMA2D              (void);
